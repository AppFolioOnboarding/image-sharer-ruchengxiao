...
class ImagesCrudTest < FlowTestCase
  test 'add an image' do
    ...
    new_image_page = new_image_page.as_a(PageObjects::Images::NewPage)
    ...
    assert_equal 'You have successfully added an image.', image_show_page.flash_message(:notice)
  ...
  test 'delete an image' do
    ...
    assert_equal 'You have successfully deleted the image.', images_index_page.flash_message(:notice)
